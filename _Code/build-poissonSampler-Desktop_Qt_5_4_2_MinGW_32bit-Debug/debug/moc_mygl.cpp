...
QT_MOC_LITERAL(1, 5, 15), // "sig_addHalfEdge"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 39, 13), // "sig_addVertex"
QT_MOC_LITERAL(5, 53, 11), // "sig_addFace"
QT_MOC_LITERAL(6, 65, 13), // "sig_clearList"
QT_MOC_LITERAL(7, 79, 11), // "timerUpdate"
QT_MOC_LITERAL(8, 91, 17), // "slot_loadFileData"
QT_MOC_LITERAL(9, 109, 38) // "slot_addVertexToCurrentHighli..."

    },
    "MyGL\0sig_addHalfEdge\0\0QListWidgetItem*\0"
    "sig_addVertex\0sig_addFace\0sig_clearList\0"
    "timerUpdate\0slot_loadFileData\0"
    "slot_addVertexToCurrentHighlightedEdge"
};
...
void MyGL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sig_addHalfEdge((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->sig_addVertex((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->sig_addFace((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 3: _t->sig_clearList(); break;
        case 4: _t->timerUpdate(); break;
        case 5: _t->slot_loadFileData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->slot_addVertexToCurrentHighlightedEdge(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::sig_addHalfEdge)) {
                *result = 0;
            }
        }
        {
        ...
        {
            typedef void (MyGL::*_t)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::sig_addFace)) {
                *result = 2;
            }
        }
        {
            typedef void (MyGL::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGL::sig_clearList)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 0
void MyGL::sig_addHalfEdge(QListWidgetItem * _t1)
{
...
// SIGNAL 2
void MyGL::sig_addFace(QListWidgetItem * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
