...
#include "../../PoissonSampler/src/cameracontrolshelp.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CameraControlsHelp_t, stringdata) + ofs \
...
const QMetaObject CameraControlsHelp::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CameraControlsHelp.data,
      qt_meta_data_CameraControlsHelp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CameraControlsHelp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CameraControlsHelp.stringdata))
