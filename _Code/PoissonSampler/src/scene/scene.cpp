...
//void Scene::SetCamera(const LensCamera &c)
//{
//    lensCamera = LensCamera(c);
//    lensCamera.create();
...
//    lensCamera = LensCamera(400, 400, Point3f(5, 8, -5), Point3f(0,0,0), Vector3f(0,1,0),
//                            lensr, focald, new Sampler(samplesPerPixel, seed));
//    lensCamera.near_clip = 0.1f;
//    lensCamera.far_clip = 100.0f;
