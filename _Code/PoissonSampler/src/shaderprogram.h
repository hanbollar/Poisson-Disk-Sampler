...
public:
    ...
    int unifTimePos; //-HB: handle for u_Time in vertex shader
    int unifTimeCol; //-HB: handle for u_Time in fragment shader
    int unifRenderMode; //-HB: handle for u_RenderMode in fragment shader
    int unifPosMode; //-HB: handle for u_PosMode in vertex shader
